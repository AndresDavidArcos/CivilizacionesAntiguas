...
export default function BoatPlayer(props, { lerp = THREE.MathUtils.lerp }) {
  ...
  return (
    <>
      <RigidBody ref={ref} colliders={"cuboid"} mass={1} type="dynamic" position={props.position} enabledRotations={[false, false, false]}>
        <Boat position={[0,1,0]} scale={[9,9,9]} rotation={[0,boatRotation,0]}/>
      </RigidBody>
    </>
  )
}
